                    ...
                    <div className="flex flex-col items-stretch ml-5 w-[62%] max-md:ml-0 max-md:w-full">
                      <div className="flex flex-col items-stretch text-base leading-6 max-md:mt-10">
                        ...
                        <div className="flex gap-2 justify-between items-stretch mt-11 whitespace-nowrap max-md:mt-10">
                          <div className="grow justify-center items-start py-3 pr-16 pl-4 text-gray-400 bg-white border border-solid border-[color:var(--Neutrals-20,#D6DDEB)] max-md:pr-5">
                            Email Address
                          </div>
                          <div className="grow justify-center items-stretch px-6 py-3 font-bold text-center text-white bg-indigo-600 max-md:px-5">
                            Subscribe
                          </div>
                        </div>
                      </div>
