    ...
    <div className=" ">
      <header className="">
        <div className="flex justify-between border pl-24">
          <div className="flex justify-between w-[382px] h-[58px] mt-5">
            <img src={job} alt=""className="object-contain w-[160px] h-[36px]"/>
            <div className="flex gap-6 mt-4">
            <a href="" className="text-black text-lg font-normal font-['Epilogue'] leading-relaxed">Find Jobs</a>
            <a href="" className="text-indigo-600 text-lg font-normal font-['Epilogue'] leading-relaxed">Browse Companies</a>
            </div>
          </div>
          <div className="flex justify-around w-[232px] h-[78px]">
            <button className="text-indigo-600 text-lg font-normal font-['Epilogue'] leading-relaxed">Login</button>
            <button className="w-[78px] h-[40px] mt-6 px-[4px] bg-indigo-600 justify-center items-center gap-1.5 text-center text-white text-lg font-bold font-['Epilogue'] leading-[28.80px]">Sign Up</button>
          </div>
        </div>
      </header>
      ...
      <div className="w-[1150px] h-[139.24px] p-5 mb-16 bg-white border border-zinc-200 justify-between items-center inline-flex">
        <div className="w-[463px] h-[91.24px] justify-center items-center gap-8 inline-flex">
          <img className="w-[91px] h-[91px] object-contain" src={filteredItem.logo} />
        ...
        <div className="w-64 h-[58.06px] justify-center items-center gap-[30px] inline-flex">
          <img className="w-8 h-[33.18px] object-contain" src={icon} alt="icon" />
      ...
      <div className="flex pl-28 mt-[32px]">
        <div className="w-[752px] flex-col justify-start items-start gap-10 inline-flex">
          ...
          <ul className="w-[630px] text-slate-600 text-lg font-normal font-['Epilogue'] leading-relaxed">
            ...
            <img src={listicon} alt="" className="w-[17px] h-[17px] object-contain"/>
        ...
        <div className="w-[300px] h-[762px] flex-col justify-start items-start gap-10 inline-flex">
          ...
          <p className=" text-slate-600 text-lg font-normal font-['Epilogue'] leading-relaxed">Apply before</p>
          <p className=" text-black font-semibold font-['Epilogue'] leading-relaxed">{filteredItem.deadline}</p>
          </div>
          <div className="flex w-[250px] h-[16px] justify-between">
          <p className=" text-slate-600 text-lg font-normal font-['Epilogue'] leading-relaxed">Job Posted On</p>
          <p className="  text-black font-semibold font-['Epilogue'] leading-relaxed">{filteredItem.postedAt}</p>
          </div>
          <div className="flex w-[250px] h-[16px] justify-between">
          <p className=" text-slate-600 text-lg font-normal font-['Epilogue'] leading-relaxed">Job Type</p>
          <p className=" text-black font-semibold font-['Epilogue'] leading-relaxed">{filteredItem.jobType}</p>
          </div>
          <div className="flex w-[250px] h-[16px] justify-between">
          <p className=" text-slate-600 text-lg font-normal font-['Epilogue'] leading-relaxed">Salary</p>
          <p className=" text-black font-semibold font-['Epilogue'] leading-relaxed">{filteredItem.salary}</p>
          </div>
          <h3 class="text-slate-800 text-[32px] mt-10 font-semibold font-['Clash Display Variable'] leading-[38.40px]">
            Categories
          </h3>
          <div className="flex gap-4">
          <p className=" text-slate-600 text-lg font-normal font-['Epilogue'] leading-relaxed border-cyan-100 bg-cyan-100 rounded-full p-4">{filteredItem.categories[0]}</p>
          <p className=" text-slate-600 text-lg font-normal font-['Epilogue'] leading-relaxed border-cyan-100 bg-cyan-100 rounded-full p-4">{filteredItem.categories[1]}</p>
          </div>
          <h3 class="text-slate-800 text-[32px] mt-10 font-semibold font-['Clash Display Variable'] leading-[38.40px]">
            Required Skills
          </h3>
          <div className="flex gap-4 flex-wrap">
          <p className=" text-blue-500 text-lg font-normal font-['Epilogue'] leading-relaxed border-neutral-100 bg-neutral-100 rounded-full p-4">{filteredItem.requiredSkills[0]}</p>
          <p className=" text-blue-500 text-lg font-normal font-['Epilogue'] leading-relaxed border-neutral-100 bg-neutral-100 rounded-full p-4">{filteredItem.requiredSkills[1]}</p>
          <p className=" text-blue-500 text-lg font-normal font-['Epilogue'] leading-relaxed border-neutral-100 bg-neutral-100 rounded-full p-4">{filteredItem.requiredSkills[2]}</p>
          <p className=" text-blue-500 text-lg font-normal font-['Epilogue'] leading-relaxed border-neutral-100 bg-neutral-100 rounded-full p-4">{filteredItem.requiredSkills[3]}</p>
        </div>
        </div>
      </div>
      <div className="pl-28">
        ...
        <div className="flex flex-wrap gap-8 mt-8">
          <div>
            <img className="w-[48px] h-[48px] object-contain" src={perk} alt="perk" />
          ...
          <div>
            <img className="w-[48px] h-[48px] object-contain" src={com} alt="perk" />
            <p class="w-[174px] text-slate-800 text-xl font-semibold font-['Clash Display Variable'] leading-normal pt-4">
              Unlimited Vacation
            </p>
            <p class="w-[274px] text-slate-600 text-lg font-normal font-['Epilogue'] leading-relaxed pt-4">
          ...
          <div>
            <img className="w-[48px] h-[48px] object-contain" src={skill} alt="perk" />
            <p class="w-[174px] text-slate-800 text-xl font-semibold font-['Clash Display Variable'] leading-normal pt-4">
              Skill Development
            </p>
            <p class="w-[274px] text-slate-600 text-lg font-normal font-['Epilogue'] leading-relaxed pt-4">
          ...
          <div>
            <img className="w-[48px] h-[48px] object-contain" src={team} alt="perk" />
            <p class="w-[174px] text-slate-800 text-xl font-semibold font-['Clash Display Variable'] leading-normal pt-4">
              Team Summits
            </p>
            <p class="w-[274px] text-slate-600 text-lg font-normal font-['Epilogue'] leading-relaxed pt-4">
          ...
          <div>
            <img className="w-[48px] h-[48px] object-contain" src={remote} alt="perk" />
            <p class="w-[174px] text-slate-800 text-xl font-semibold font-['Clash Display Variable'] leading-normal pt-4">
              Remote Working
            </p>
            <p class="w-[274px] text-slate-600 text-lg font-normal font-['Epilogue'] leading-relaxed pt-4">
          ...
          <div>
            <img className="w-[48px] h-[48px] object-contain" src={commuter} alt="perk" />
            <p class="w-[174px] text-slate-800 text-xl font-semibold font-['Clash Display Variable'] leading-normal pt-4">
              Commuter Benefits
            </p>
            <p class="w-[274px] text-slate-600 text-lg font-normal font-['Epilogue'] leading-relaxed pt-4">
          ...
          <div className="">
            <img className="w-[48px] h-[48px] object-contain" src={group} alt="perk" />
            <p class="w-[174px] text-slate-800 text-xl font-semibold font-['Clash Display Variable'] leading-normal pt-4">
              We give back.
            </p>
            <p class="w-[274px] text-slate-600 text-lg font-normal font-['Epilogue'] leading-relaxed pt-4">
      ...
      <section className="flex  mt-20 justify-between items-center pl-28">
        ...
        <div className="flex mr-10">
          <img className="w-[316px] h-[217px] rounded object-contain" src={imgtwo} alt="" />
          <div>
            <img className="w-[150px] h-[133px] object-contain" src={imgone} alt="" />
            <img className="w-[150px] h-[133px] object-contain" src={imgthree} alt="" />
          </div>
        </div>
      </section>
      ...
      <div className="p-4 mt-10">
        <div className=" bg-white gap-6">
          <div className="flex justify-between w-[1100px] mt-10">
            ...
            <p className="text-center text-indigo-600 text-xl font-semibold font-['Epilogue'] leading-relaxed">Show all jobs</p>
          </div>

          <div className="w-[680px]  grid grid-cols-2 mx-auto gap-10 mt-10">
